...
export const TopBar: React.FC<TopBarProps> = ({ 
  ...
  return (
    <header className="relative flex-shrink-0 h-14 md:h-16 flex items-center justify-between px-3 md:px-8 bg-bg-primary border-b border-transparent md:border-none">
      <div className="flex items-center gap-2 md:gap-4 flex-shrink min-w-0 flex-1">
        ...
        {/* Logo - Hide on mobile if deep in a project to make room for project name */}
        <button 
            onClick={onGoToHub} 
